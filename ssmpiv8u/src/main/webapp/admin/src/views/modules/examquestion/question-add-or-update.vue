<template>
  <div>
    <el-form
      ...
      label-width="80px"
    >
      <el-form-item label="选择知识竞赛" prop="paperid">
        <el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择知识竞赛">
          <el-option
      ...
      <el-form-item label="竞赛试题" prop="questionname">
        <el-input
          style="width:600px;"
          type="textarea"
          min="1"
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        paperid: [{ required: true, message: "请选择知识竞赛", trigger: "blur" }],
        questionname: [
          { required: true, message: "竞赛试题内容不能为空", trigger: "blur" }
        ],
        type: [{ required: true, message: "请选择竞赛试题类型", trigger: "blur" }],
